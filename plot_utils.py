...
#MODIFICA: stampa stats solo se printstats=True
def plot_graph(g, path=None, filename=None, printstats=True, xMin=-1., xMax=32., yMin=-1., yMax=-1.):
    global canvas
    # Naming canvases this way will produce a runtime warning because ROOT
    # will always make a default canvas with name `c1` the first time you
    # fit a histogram. The only way I know how to get rid of it is to
    ...
    if printstats==True:
        ...
        latex2 = ROOT.TLatex( 0.20, 0.90,lab2)
    latex2.SetNDC()
